...
public class Ex05 {
	...
	public static void main(String[] args) {
		//ประกาศตัวแปรอาร์เรย์ชื่อ nums เก็บชุดตัวเลข คือ 23, 67, 8, 91, 45, 12, 78 ➔ เขียนคำสั่งลบข้อมูลตัวสุดท้ายของอาร์เรย์ออก โดย
		//แสดงผลตั้งแต่ ชุดข้อมูลเดิม → ชุดข้อมูลที่ลบข้อมูลตัวสุดท้ายออกเรียบร้อยแล้ว
